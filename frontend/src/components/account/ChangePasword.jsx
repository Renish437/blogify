                        ...
                        <div className="space-y-6">                             
                            <div className="bg-white shadow rounded-lg p-6">
                                ...
                                <div className="space-y-4 max-w-md">
                                    ...
                                    <div>
                                        <label htmlFor="newPassword" className="block text-sm font-medium text-gray-700 my-3">
                                            New Password
                                        </label>
                                        <div className="relative">
                                            <input
                                    ...
                                    <div>
                                        <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-700 my-3">
